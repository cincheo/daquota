    ...
    template: `
        <div :id="cid" :style="componentBorderStyle()">
            ...
            <component-badge :component="getThis()" :edit="edit" :targeted="targeted" :selected="selected"></component-badge>
                <component-view v-for="(item, index) in dataModel" :key="viewModel.body ? viewModel.body.cid : undefined" :cid="viewModel.body ? viewModel.body.cid : undefined" keyInParent="body" :iteratorIndex="index" />
