...
<div class="${properties.kcFormGroupClass!} ${messagesPerField.printIfExists('company',properties.kcFormGroupErrorClass!)}">
  <div class="${properties.kcLabelWrapperClass!}">
    <label for="user.attributes.company" class="${properties.kcLabelClass!}">Company</label>
  </div>
  <div class="${properties.kcInputWrapperClass!}">
    <input
      type="text"
...
<div class="${properties.kcFormGroupClass!} ${messagesPerField.printIfExists('function',properties.kcFormGroupErrorClass!)}">
  <div class="${properties.kcLabelWrapperClass!}">
    <label for="user.attributes.function" class="${properties.kcLabelClass!}">Function</label>
  </div>
  <div class="${properties.kcInputWrapperClass!}">
    <input
      type="text"
